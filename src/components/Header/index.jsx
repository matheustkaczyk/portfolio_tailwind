function Header() {
  ...
  return (
    <header className={`absolute w-full top-0 left-0 transition-all text-white duration-500 bg-opacity-5 bg-gray-400 ease-in-out z-50`}>
      <div className="max-w-7xl mx-auto p-5">
        <div className='flex flex-row justify-between items-center h-auto'>
          ...
          <ul>
            <li className='inline-block mx-2 hover:text-gray-600'>
